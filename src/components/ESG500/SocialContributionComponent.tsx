...
export default function SocialContributionComponent() {
  ...
  return (
    <>
      <div className="w-full mt-[160px] flex flex-col items-end min-h-screen bg-no-repeat bg-cover bg-white ">
        <div className="w-2/3">
          <Image
            ...
            className="mb-32 ml-[448px]"
          />

          {/* Tabs */}
          <div className="mt-24 w-full flex items-center justify-center">
            <button
              className={`w-2/5 h-[48px] tab-button1 ${isActive('tab1') ? 'active-tab1' : ''}`}
              value="tab1"
            ...
            <button
              className={`w-2/5 h-[48px]  tab-button2 ${isActive('tab2') ? 'active-tab2' : ''}`}
