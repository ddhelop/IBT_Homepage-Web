      ...
      <div className="w-full flex flex-col justify-center align-middle items-center">
        ...
        <div className="w-full flex flex-col lg:flex-row p-3">
          <div className="lg:w-1/4 flex ">
            <div className="h-20 border-t-2 text-base tracking-wider text-[#9a9a9a] border-t-[#4be7ff] flex items-center justify-center">
              재단소개 및 사업내용
            </div>
          </div>
          <p className="lg:w-3/4 text-base leading-9 tracking-wider text-[#7b7b7b]">
        ...
        <div className="w-full flex flex-col lg:flex-row p-3 mt-24">
          <div className="lg:w-1/4 flex ">
            <div className="h-20 border-t-2 text-base tracking-wider text-[#9a9a9a] border-t-[#4be7ff] flex items-center justify-start">
          ...
          <div className="lg:w-3/4 flex flex-col">
            ...
            <h3 className="text-3xl mt-28 font-medium text-[#787878]">기부금 모금 및 사용 현황</h3>
              ...
              <table className="min-w-full">
                ...
                <tbody className="text-base">
                  <tr className="bg-[#f0f0f0]">
                    <td className="border px-4 py-2 text-center">모금</td>
                  ...
                  <tr>
                    <td className="border px-4 py-2 text-center">사용</td>
                    <td className="border px-4 py-2 text-center">0</td>
                    <td className="border px-4 py-2 text-center">0</td>
                    <td className="border px-4 py-2 text-center">200</td>
                    <td className="border px-4 py-2 text-center">400</td>
