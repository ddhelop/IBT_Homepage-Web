  ...
  return (
    <>
      <div className="w-full p-5 md:p-20 flex flex-col items-center lg:items-start min-h-screen bg-no-repeat bg-cover bg-white ">
        <div className="flex flex-col max-w-[27rem] lg:max-w-none">
          <Image
        ...
        <div className="w-full mt-36 lg:mt-72 flex flex-col items-center lg:items-start">
          ...
          />
          <h1 className="text-5xl font-medium lg:ml-56 lg:my-12">윤리경영 보고서</h1>
          <div className="w-full flex flex-col justify-end items-center">
            <div className="lg:w-3/4 flex flex-col lg:flex-row p-3 mt-28">
              <div className="lg:w-1/4 flex w-full">
                <div className=" h-[40px] text-xl tracking-wider text-[#9a9a9a] flex items-center justify-start">
                  <p className="">재단 소개 및 사업내용</p>
                </div>
              </div>
          ...
          <div className="w-full lg:flex md:flex-col justify-end items-center">
            <div className="lg:w-3/4 flex flex-col lg:flex-row p-3 mt-28">
              <div className="lg:w-1/4 flex">
                <div className=" h-[80px] border-t-2 text-xl tracking-wider text-[#9a9a9a] border-t-[#4be7ff] flex items-center justify-start">
                  투명 경영
                </div>
              </div>
              ...
              <div className="lg:w-3/4 flex flex-col">
                ...
                <p className="text-lg leading-9 tracking-wider text-[#7b7b7b]">
