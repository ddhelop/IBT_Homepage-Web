...
export const metadata: Metadata = {
  title: '(주)아이비티 수소 발전',
  description: 'IBT 수소 발전 연료전지 시스템 페이지',
}

const HydrogenServicePage = async () => {
  const data = await fetchPageData(3, 'hydrogen')
    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center min-h-[90vh]">
        <div className="w-[min(92%,1280px)]">
          <HydrogenDetail title={hydrogenListData[3].title} explain={hydrogenListData[3].explain} />
          {/* 소분류 컴포넌트 */}
...
export default HydrogenServicePage
