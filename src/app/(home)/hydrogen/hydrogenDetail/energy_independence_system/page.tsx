...
export const metadata: Metadata = {
  ...
  description: 'IBT 에너지 자립 시스템 설비 페이지',
}

const EnergyIndependenceSystemPage = async () => {
  const data = await fetchPageData(4, 'hydrogen')
    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center min-h-[90vh]">
        <div className="w-[min(92%,1280px)]">
          <HydrogenDetail title={hydrogenListData[4].title} explain={hydrogenListData[4].explain} />
          {/* 소분류 컴포넌트 */}
...
export default EnergyIndependenceSystemPage
