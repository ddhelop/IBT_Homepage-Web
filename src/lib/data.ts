...
export const energySaveList = [
  {
    ...
    itemAdvanced: [
      '1. 경량화 소형화- 납축전지 대비 더 가볍고 크기도 더 작아 설치가 쉬움',
      '2.긴 수명 - 배터리 교체에 대한 비용 절감',
      '3. 높은 충 방전 효율- 빠른 충전과 고출력으로 운영성을 높여줌',
      '4. 통합 배터리 관리 시스템(BMS)- BMS를 통해 지속적으로 배터리를 최적화 하여 성능을 극대화 하고 안정성 유지',
      '5. Module구성- Module 구성으로 필요한 용량 및 전압에 맞게 설치 가능',
    ],
  },
  {
    title: 'ESS용',
    ...
    itemAdvanced: [
      '1. 고밀도 에너지 저장 능력: 높은 에너지 밀도로 ESS의 효율성과 용량을 극대화합니다.',
      '2. 장기 안정성 및 내구성: 수천 회의 충전 및 방전 주기에 걸쳐 일관된 성능을 유지합니다.',
      '3. 높은 충전 및 방전 효율: 뛰어난 충전 및 방전 효율성으로 에너지 손실을 최소화하고 전체 시스템의 효율을 증가시킵니다.',
      '4. 환경적 지속 가능성: 환경 친화적인 재료로 제작되어 재활용 가능성을 고려하여 환경 영향을 최소화합니다.',
      '5. 안전성:  첨단 BMS(배터리 관리 시스템)이 과열, 과충전 및 과방전으로부터 보호해주어 안전성이 보장됩니다.',
      '6. 규제 및 표준 준수: IBT의 배터리는 국제적인 안전 및 환경 규제를 준수하며, 엄격한 표준을 따릅니다.',
      '7. 경제성: 전체 소유 비용을 고려한 경제적 설계로, 장기적인 비용 절감이 가능합니다.',
      '8. 적응성 및 확장성: 다양한 ESS 응용 분야에 적합하도록 설계되었으며, 시스템의 확장 요구 사항에 유연하게 대응할 수 있습니다.',
    ],
  },
]
